      ...
      <div class="card">
        <div class="card-body p-4">
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <h5 class="mb-3"><a href="Accueil" class="text-body"><i
              ...
              <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                  ...
                  <p class="mb-0">Vous avez <?= $nbArticle; ?> articles dans votre panier</p>
                </div>
              </div>
              <?php foreach($_SESSION['panier'] as $articlePanier): ?>
              <div class="card mb-3">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div class="d-flex flex-row align-items-center">
                      ...
                      <div class="ms-3">
                        <h5><?php foreach ($articles as $article) : 
                          if($article->id() == $articlePanier[0]){
                            echo $article->name();
                          }
                          endforeach;?></h5>
                        <p class="small mb-0"><?php foreach ($articles as $article) : 
                          if($article->id() == $articlePanier[0]){
                    ...
                    <div class="d-flex flex-row align-items-center">
                      <div style="width: 50px;">
                        <h5 class="fw-normal mb-0"><?= $articlePanier[1] ?></h5>
                      </div>
                      <div style="width: 80px;">
                        <h5 class="mb-0"><?php foreach ($articles as $article) : 
                          if($article->id() == $articlePanier[0]){
                ...
                <div class="card-body">
                  ...
                  <form class="mt-4">
                    <div class="form-outline form-white mb-4">
                      ...
                      <label class="form-label" for="typeName">Nom du titulaire de la carte</label>
                    </div>
                  ...
                  <div class="d-flex justify-content-between">
                    <p class="mb-2">Frais d'expédition</p>
                  ...
                  <button type="button" class="btn btn-secondary text-center btn-block btn-lg">
                    <div class="d-flex justify-content-between">
