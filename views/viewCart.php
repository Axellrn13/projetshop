              ...
              <div class="row g-0">
                    ...
                    <div class="row mb-4 d-flex justify-content-between align-items-center">
                      ...
                      foreach ($_SESSION['panier'] as $articlePanier):
                        ...
                        <div class="col-md-2 col-lg-2 col-xl-2 mb-3">
                          <img src="images/<?php foreach ($articles as $article):
                            if ($article->id() == $articlePanier[0]) {
                              echo $article->image();
                            }
                          endforeach; ?>" class="img-fluid rounded-3" alt="Cotton T-shirt">
                        </div>
                ...
                <div class="col-lg-4 bg-grey">
                  <div class="p-5">
                    ...
                    <a href="cart&totalCart=<?= $prixTotal * 1.2 ?>">
                      <button type="submit" class="btn btn-dark btn-block btn-lg" data-mdb-ripple-color="dark">Valider
                        votre panier</button></a>
                  </div>
                </div>
              </div>
            </div>
